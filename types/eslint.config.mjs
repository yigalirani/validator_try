...
export default defineConfig(globalIgnores(["**/dist/", "**/types/", '**/node_modulests']), eslint.configs.recommended, //taking all rules from eslint, truning select ones off below
